...
export class ConfigmapsResourceFactory extends ResourceFactoryBase implements ResourceFactory {
  constructor() {
    super({
      resource: 'configmaps',
    });
  ...
  createInformer(kubeconfig: KubeConfigSingleContext): ResourceInformer<V1ConfigMap> {
